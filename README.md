...
2. **Отдельные файлы (только для выбранных месяцев):**
   ...
   - Имя файла: `M-{месяц}_{тип}_{timestamp}.xlsx`
   - Пример: `M-1_UP_20251112_2001.xlsx`
...
- `_save_month_sheet(df, month, fact_type)` - Сохраняет лист для указанного месяца в отдельный Excel файл
